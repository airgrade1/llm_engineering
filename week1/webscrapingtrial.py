...
# Check if the API key was found and appears valid
if not api_key:
...
# Send a test message to verify the API is functioning
...
def user_prompt_for(website):
    ...
    """
    user_prompt = """fYou are looking at a website titled {website.title}"
...
with open("webscrape.txt", "w") as file1:
