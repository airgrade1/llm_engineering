...
from assistant_prompt_brochure_creator import brochure_assistant_prompt_1, brochure_assistant_prompt_2, \
    brochure_assistant_prompt_3
...
import assistant_prompt_brochure_creator
...
def create_brochure(company_name, url):
    ...
    response = openai.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "assistant", "content": brochure_assistant_prompt_1},
            {"role": "assistant", "content": brochure_assistant_prompt_2},
            {"role": "assistant", "content": brochure_assistant_prompt_3},
            # {"role": "user", "content": ""}
        ],
    )
    result = response.choices[0].message.content
